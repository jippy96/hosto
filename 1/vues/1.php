                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Vue Statistique</h2>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="au-card m-b-30">
                                    <div class="au-card-inner">
                                        <h3 class="title-2 m-b-40">Consultation par catégorie de patient</h3>
                            ...
                            <div class="col-lg-6">
                                <div class="au-card m-b-30">
                                    <div class="au-card-inner">
                                        <h3 class="title-2 m-b-40">Consultation mensuelle des patients</h3>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Vue Comptabilité</h2>
                                ...
                                <table class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" scope="col">Nombre de Consultation</th>
