                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="../images/4802.png" width="100px" alt="CoolAdmin">
                            </a>
                        </div>
                            ...
                            <form action="?action=auth&erreur=0" method="post">
                                ...
                                <?php if (isset($_GET['erreur']) && $_GET['erreur']==1) {
                                    ...
                                    echo '<div class="alert alert-danger text-center erreur" role="alert">
                                            Echec de connexion, veuillez vérifier vos informations !
                                          </div>';
                                }
                                ?>
                               ...
                               <button class="btn btn-primary btn-block m-b-20"> <a href="#" style="color: whitesmoke;">Créer un Utilisateur</a> </button>                               
                            </form>
