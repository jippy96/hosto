           ...
           <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h3 class="text-center">Enregistrement d'une nouvelle indication</h3>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-md-6 col-lg-6 offset-3">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="./?action=sendIndication" method="post" class="">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="nf-email" class=" form-control-label">Nature de l'indication</label>
                                                        <input required type="text" id="nf-email" name="indication" placeholder="Entrer son libellé.." class="form-control">
                                                    </div> 
                                                </div>                                   
                                            </div> 
