                                    ...
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td><?= $indication['libelle_Indication'] ?></td>
                                                <td>
                                                    <div class="table-data-feature">
                                                        
                                                        <a href="./?action=editIndication&indication=<?= $indication['id_Indication'] ?>"><button class="item" data-toggle="tooltip" data-placement="top" title="Editer">
                                                            <i class="zmdi zmdi-edit"></i>
                                                        </button></a>
                                                        <a href="./?action=deleteIndication&indication=<?= $indication['id_Indication'] ?>"><button class="item" data-toggle="tooltip" data-placement="top" title="Supprimer">
