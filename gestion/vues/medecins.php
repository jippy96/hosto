                                    ...
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                <?= $medecin['prenomsMedecin'] ?>
                                                </td>
                                                <td> <?= $medecin['contact'] ?></td>                                                
                                                <td>
                                                    <div class="table-data-feature">
                                                        
                                                        <a href="./?action=edit&medecin=<?= $medecin['id_Medecin'] ?>"><button class="item" data-toggle="tooltip" data-placement="top" title="Editer">
                                                            <i class="zmdi zmdi-edit"></i>
                                                        </button></a>
                                                        <a href="./?action=delete&medecin=<?= $medecin['id_Medecin'] ?>"><button class="item" data-toggle="tooltip" data-placement="top" title="Supprimer">
